<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
	...
	function handle_upload($namafile,$path = '',$newfilename = "")
	{
		...
		$config['allowed_types']	= 'image/jpg|jpg|image/png|png|application/octet-stream|application/x-pdf|octet-stream|application/pdf|pdf|aplication/pdf|application/download|application/x-download|mov|mp4';
