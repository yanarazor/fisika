  ...
  <div class="wrapper">
          ...
          <div class="row">
            ...
            <div class="col-sm-5">
              <ol class="breadcrumb pull-right hidden-xs">
                ...
                <li><a href="#"><?php echo lang('bf_paten'); ?></a></li>
      ...
      <div class="container">
        ...
        <div class="row blog-p">
          ...
          <div class="col-sm-6">
          	<p class="text-muted">
                <?php echo html_entity_decode($recordpenelitian->abstrak); ?>
              </p>
              <p class="text-muted">
              Penemu :
               </p>
				 ...
				 ?>
					   <?php e($i); ?>. <a href="<?php echo base_url();?>emp/view/<?php echo $record->nip_penemu; ?>/<?php echo $convert->SeoUrl($record->nama); ?>"><?php echo $record->nama; ?></a><br>
				 <?php	
				  $i++;
					  endforeach;
				  endif;
