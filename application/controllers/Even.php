 ...
 *
 */
class even extends Front_Controller
{
	...
	public function index()
	{
		...
		$this->berita_model->where("category","3");
		$total = $this->berita_model->count_all_event($keyword);
		...
		$this->berita_model->where("category","3");
		$recordberitas = $this->berita_model->limit($limit, $offset)->all_event($keyword);
